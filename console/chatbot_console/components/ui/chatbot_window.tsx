    ...
    <div className="fixed bottom-4 right-4 z-50">
      {!isExpanded ? (
        <Button
          ...
          className="bg-[#b30738] hover:bg-[#811e2d] w-14 h-14 rounded-full shadow-lg transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl"
        >
            ...
            <CardFooter className="p-3">
              ...
              >
                <Textarea
                  ...
                  rows={1}
                />
                <Button type="submit" size="icon" className="mb-[1px] bg-[#b30738] hover:bg-[#811e2d]">
